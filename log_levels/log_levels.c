...
MODULE_DESCRIPTION("printing all the kernel log levels");
MODULE_LICENSE("Dual MIT/GPL");
MODULE_VERSION("0.1");

static int __init print_loglevel_init(void)
{
...
static void __exit print_loglevels_exit(void)
{
    pr_info("Goodbye, world @ log-level KERN_INFO    [6]\n");
}

module_init(print_loglevel_init);
module_exit(print_loglevel_exit);
